...
// echo $status = curl_post("https://simak.poliupg.ac.id/api/machine/post_login","42518066","hendra3005");
// $arstatus = json_decode($status,true);
// if(isset($arstatus['error']))	echo "Password salah";
// else echo "Hello ". $arstatus['nama'];
/**/

$status = curl_get("https://simak.poliupg.ac.id/api/machine/get_tabel_konten/bri_mhs_aktif/thn_ajar/20201/kode_prodi/425/kelas/3A");
...
// }
file_put_contents("datasimak.txt",json_encode($arrMhs));
